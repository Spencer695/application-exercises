...
There are 1615 movies in our filtered datas et.
...
**How many movies passed the test?** 753 movies passed.

**How many failed?** 862 movies failed. 
...
Since many of the high budget films are more action and male lead focused it makes these less likely to pass the Bechdel test. Also with the larger budgets they have better marketing support so they do bet at the box office than a lower budget would. The result is that movies with higher median budgets and earnings are more likely to fail the Bechdel test.
...
**Your answer:** The category with the highest median budget is notalk. 

**Task 3.2:** Which category has the highest median international gross?

**Your answer:** The catagory that has the highest median international gross is notalk. 
...
The movie with the highest ROI is Paranormal Activity.

**Task 4.2:** What is its ROI value?

**Your answer:** 

Its ROI value is 671.336857.

**Task 4.3:** Does this movie surprise you? Why or why not?

**Your answer:**

NO, since the budget was extremely small and it got super popular so the ROI makes sense. 
...
The plot is difficult to interpret due to the ROI values being highly skewed and having extreme outliers. Some of the movies have huge ROI values, which makes the y-axis longer and the data gets squished towards zero. This makes the boxplots flat and hard to compare to the ROI across the categories. 
...
There are 3 movies that have an ROI greater than 400.

**Task 5.3:** What do you notice about the budgets of these high-ROI movies?

**Your answer:**

There budgets are all really small compared to a standard movies budget. This shows how low cost movies can make very bit returns relative to their investment. 
...
ggplot(data = bechdel90_13, 
  ...
  labs(
    title = "Return on investment vs. Bechdel test result",
    subtitle = "Zoomed in to show ROI values between 0 and 15", # Something about zooming in to a certain level
    x = "Detailed Bechdel result",
...
The OK category has the highest median ROI. 

**Task 7.2:** Do movies that pass the Bechdel test (binary = PASS) appear to have higher or lower ROI than those that fail?

**Your answer:**

They have higher ROI than those that fail. 

**Task 7.3:** What does this suggest about the financial argument for including women in films?

**Your answer:**

Movies that include meaningful representation of women are not less profitable and could possibly perform better financially since there is no financial disadvantage to including women in films. 
...
The mean ROI is is higher for movies that fail the Bechdel test, while the medians seen earlier suggested that movies that pass the test had higher ROI. The differences happen due to ROI distribution being skewed with the extreme outliers. A few very high ROI movies moves the mean up while the median is less affected by these extreme values. The mean is better for representing the typical movie. 
